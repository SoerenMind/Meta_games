...
def gan_objective(gen_params, dsc_params, gen_subs_params, real_data, num_samples, noise_dim, rs):
    fake_data = generate_from_noise(gen_params, num_samples, noise_dim, rs)
    input_params = gen_subs_params if subspace_training else gen_params
...
if __name__ == '__main__':
    ...
    latent_dim = 1
    data_dim = 1
    gen_subspace_dim, dsc_subspace_dim= 500, 1000
